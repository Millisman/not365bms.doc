...
class bq769x0 {
    ...
    uint8_t i2buf[4];
public:
    enum BqIC { bq76920, bq76930, bq76940 };
    ...
    bq769x0(BqIC bqType = bq76940, uint8_t bqI2CAddress = 0x08, bool crc = true);
...
private:
    ...
    bool crcEnabled_;
    bool alertInterruptFlag_; // indicates if a new current reading or an error is available from BMS IC
